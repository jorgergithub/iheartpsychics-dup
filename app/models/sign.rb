class Sign
  ...
  Sagittarius = Sign.new("Sagittarius", 7, Date.new(BASIC_YEAR     ,10,24), Date.new(BASIC_YEAR    , 11,22))
  Scorpio     = Sign.new("Scorpio", 8,     Date.new(BASIC_YEAR     ,11,23), Date.new(BASIC_YEAR    , 12,21))
