Module("IHP.Modals.HeroModal", function(Modal) {
  ...
  Modal.fn.video = function() {
    return $('<iframe width="640" height="360" src="//www.youtube.com/embed/FneaWvYc8Xs?rel=0&autoplay=1&controls=0&showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe>');
  };
